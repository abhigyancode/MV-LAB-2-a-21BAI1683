# -*- coding: utf-8 -*-
"""MV LAB 2(a) 21BAI1683.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1q25fnAW6UPeTazN8nEeO4q0LeZYZP31l
"""
...
satellite_img = cv2.imread('/ID_6_Banner_San_Diego_PHR_1_B_20150724_47f7833729.webp')
...
mri_img = cv2.imread('/MRI_of_Human_Brain.jpg')
...
drone_img = cv2.imread('/komarovsky_759_fb.webp')
...
old_photo = cv2.imread('/history.jpeg')
...
arch_img = cv2.imread('/house.jpeg')
